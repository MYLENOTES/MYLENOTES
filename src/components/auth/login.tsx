            ...
            <div className="flex flex-col justify-center items-center gap-3">
              <form onSubmit={handleLogin} className="flex flex-col w-full gap-3">
                <div className="flex flex-col gap-1.5">
                  <label
                    htmlFor="email"
                    className="text-text text-xs font-medium opacity-80"
                  >
                    Email Address
                  </label>
                  <input
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex justify-end mt-0.5">
                    <button
                      ...
                      className="text-primary text-xs hover:text-primary hover:opacity-80 transition-all"
                    >
                      Forgot password?
                    </button>
                  </div>
                ...
                <button
                  className="bg-primary bg-opacity-90 hover:bg-opacity-100 text-background font-semibold text-sm mt-1 py-2 px-4 rounded-lg transition-all duration-300 shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  type="submit"
                  disabled={loading}
                >
